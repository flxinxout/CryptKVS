...
#include "util.h"
#include "libmongoose/mongoose.h" //TODO changed from mongoose.h to libmongoose/mongoose.h
...
/**
 * @brief Format to print an entry key
 */
#define ENTRY_KEY_FORMAT "%-5s: "STR_LENGTH_FMT(CKVS_MAXKEYLEN)"\n"

/**
 * @brief Format to print details about an entry value
 */
#define ENTRY_VALUE_FORMAT "%-5s: off %lu len %lu\n"

/**
 * @brief Global pattern for stats HTTP request
 */
#define STATS_PATTERN "/stats"

/**
 * @brief Global pattern for get HTTP request
 */
#define GET_PATTERN "/get"

/**
 * @brief Global pattern for set HTTP request
 */
